...
import com.example.ble_serv.permissions.PermissionsUtil
...
fun ConnectionScreen(
    ...
    val permissionState =
        rememberMultiplePermissionsState(permissions = PermissionsUtil.permissions)
        ...
        Column(
            ...
            if (bleConnectionState == ConnectionState.CurrentlyInitializing) {
                ...
                Column(
                    ...
                    Text(
                        text = "Humidity: ${viewModel.resultBLE}",
                    )
                }
